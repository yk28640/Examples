    ...
    internal static class Program
    {
        ...
        static void Main(string[] args)
        {
           ...
           //// lastWriteTimeUtc = fileInfo.LastWriteTimeUtc; // fileInfo not defined
            ...
            //argsSet[1] = @"E:\projects\FM2 Project\CATL Siemens PLC and HMI Template_V20_20260708_1646\CATL Siemens PLC and HMI Template_V20_20260708_1646.ap20";
            //argsSet[2] = "ET 200SP station_5";
            //RunCompare(argsSet);
        ...
        private static void RunCompare(string[] args)
        {
            ...
            try
            {
                var tia = new TiaOpennessClient(withUserInterface: true);
                    ...
                    var compareResult = tia.ComparePlcProgramOnline( projectPath);
